			...
			<div class="col col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
				<div class="crumina-module crumina-heading">
					...
					<p class="heading-text color-white">
						Kindly check your internet connection and click "return to home" and  if this problem persists, send us a mail to: <a href="mailto:support@konstructapp.com" target="_blank">support@konstructapp.com</a>
					</p>
